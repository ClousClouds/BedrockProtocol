...
final class ResourcePackStackFinishedResourcePackClientResponse extends ResourcePackClientResponse{

	public function getType() : ResourcePackClientResponseType{
		return ResourcePackClientResponseType::RESOURCE_PACK_STACK_FINISHED;
	}
